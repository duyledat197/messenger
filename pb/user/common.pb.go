...
const file_user_common_proto_rawDesc = "" +
	"\n" +
	"\x11user/common.proto\x12\x04user\"\xb2\x01\n" +
	"\x04User\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x14\n" +
	"\x05phone\x18\x02 \x01(\tR\x05phone\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12\x14\n" +
	"\x05gmail\x18\x04 \x01(\tR\x05gmail\x12\x1a\n" +
	"\bfacebook\x18\x05 \x01(\tR\bfacebook\x12\x18\n" +
	"\adiscord\x18\x06 \x01(\tR\adiscord\x12\x16\n" +
	"\x06github\x18\a \x01(\tR\x06githubB\x1cZ\x1aopenmyth/messgener/pb/userb\x06proto3"
